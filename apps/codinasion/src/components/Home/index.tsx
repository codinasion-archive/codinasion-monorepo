...
export default function Home() {
    ...
    return (
        <>
            <Image src={theme === 'dark' ? "/img/bg_dark.png" : "/img/bg_light.png"} width={5000} height={5000} className="w-full h-full object-cover absolute min-h-screen top-0 left-0 blur-sm" />
            ...
            <section className="p-3 xl:container mx-auto w-full relative">
                <article className="w-full md:flex justify-center gap-5 lg:gap-10 items-center pt-20">
                    ...
                    <section className="max-w-[800px] space-y-2 md:space-y-3 pt-5 md:pt-32">
                        <h1 className="text-3xl md:text-5xl font-extrabold text-black dark:text-white">CODINASION</h1>
                        <p>
                            Welcome to Codinasion - a community of passionate developers,
                            where we share our knowledge and experience with each other. Whether you are a beginner or an experienced developer.
